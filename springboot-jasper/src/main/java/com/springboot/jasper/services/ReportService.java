...
//			JasperExportManager.exportReportToPdfStream(jasperPrint,new FileOutputStream("src/main/resources/reports/report.pdf"));
			JasperExportManager.exportReportToPdfStream(jasperPrint,new FileOutputStream("D:/Nana/jasper-tutorial/report-sample.pdf"));
	...
	private ByteArrayResource exportReportToDOCx(InputStream targetStream, Map<String, Object> parameters) {
		try {
			...
			exporter.setExporterOutput(
					new SimpleOutputStreamExporterOutput(new File("src/main/resources/reports/reports.docx")));
